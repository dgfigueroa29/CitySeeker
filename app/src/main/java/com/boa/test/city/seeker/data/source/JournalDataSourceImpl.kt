...
constructor(
    ...
    override fun getEntriesForCity(cityId: Long): Flow<List<JournalEntity>> =
        journalDao.getEntriesForCity(cityId)

    override fun getAllEntries(): Flow<List<JournalEntity>> =
        journalDao.getAllEntries()

    override suspend fun getEntryById(id: Long): JournalEntity? =
